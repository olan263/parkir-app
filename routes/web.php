...
// Mengarahkan langsung ke dashboard admin sebagai halaman utama
...
Route::prefix('parkir/masuk')->group(function () {
    ...
    Route::post('/proses', [ParkingController::class, 'masuk'])->name('parkir.masuk'); // URL: /parkir/masuk/proses
...
Route::prefix('parkir/keluar')->group(function () {
    ...
    Route::post('/proses', [ParkingController::class, 'keluar'])->name('parkir.keluar'); // URL: /parkir/keluar/proses
